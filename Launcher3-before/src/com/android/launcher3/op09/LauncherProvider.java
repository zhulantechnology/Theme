...
public class LauncherProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        /// M: Add for OP customization.
        LauncherExtPlugin.getInstance().initCellCount(getContext());
    ...
    synchronized public void loadDefaultFavoritesIfNecessary() {
        ...
        if (sp.getBoolean(EMPTY_DATABASE_CREATED, false)) {
            ...
            // M: don't empty DB here, or will have CR ALPS02703250,ALPS02314317
            // createEmptyDB();
    ...
    protected static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            /// M: Add for OP customization. @{
            LauncherExtPlugin.getInstance()
                .createAllAppsTable(db, mContext, getDefaultUserSerial());
            /// @}
        ...
        private void removeOrphanedItems(SQLiteDatabase db) {
            ...
            String removeOrphanedDesktopItems = "DELETE FROM " + TABLE_FAVORITES +
                    ...
                    LauncherSettings.WorkspaceScreens._ID + " FROM " +
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            switch (oldVersion) {
                ...
                case 16: {
                    ...
                    // is very destructive (wipes out workspaces), we want to prevent this from
                    // showing until clear data. We do so by marking that the clings have been
                    // shown.
                ...
                case 18: {
                    ...
                    // which no longer exist. Since this can cause other problems, and since the
                    // user will never see these items anyway, we use database upgrade as an
                ...
                case 19: {
                    ...
                    /// M: Add for OP customization. @{
                    boolean supportEditApps = LauncherExtPlugin.getInstance()
                                                .supportEditAndHideApps();

                    Log.d(TAG, "onUpgrade, supportEditApps=" + supportEditApps);
                    if (supportEditApps) {
        ...
        void createAllAppsTable(SQLiteDatabase db) {
            ...
            LauncherExtPlugin.getInstance()
                .createAllAppsTable(db, mContext, userSerialNumber);
        }
