...
public class AllAppsGridAdapter extends RecyclerView.Adapter<AllAppsGridAdapter.ViewHolder> {
    ...
    /// M: Add for OP customization. @{
    public static final int FOLDER_VIEW_TYPE = 6;
    public static final int FOLDER_ICON_PADDING_TOP = 16;
    public int mFolderIconPaddingTop = -1;
    /// @}
    ...
    public class GridItemDecoration extends RecyclerView.ItemDecoration {
        ...
        public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
            ...
            if (DEBUG_SECTION_MARGIN) {
                ...
                c.drawRect(mBackgroundPadding.left, 0,
                        mBackgroundPadding.left + mSectionNamesMargin,
        ...
        private PointF getAndCacheSectionBounds(String sectionName) {
            ...
            if (bounds == null) {
                ...
                bounds = new PointF(mSectionTextPaint.measureText(sectionName),
                    mTmpBounds.height());
        ...
        /**
         * Returns whether we consider this a valid view holder for us to
         * draw a divider or section for.
         */
    ...
    public AllAppsGridAdapter(Launcher launcher, AlphabeticalAppsList apps,
        ...
        // Disable the reverse layout.
        mGridLayoutMgr.setReverseLayout(false);
        /// @}
    }
    ...
    public void setLastSearchQuery(String query) {
        ...
        if (mMarketAppName != null) {
            mMarketSearchMessage = String.format(res.getString(
                    R.string.all_apps_search_market_message),
                    mMarketAppName);
        ...
        switch (viewType) {
            ...
            case SEARCH_MARKET_DIVIDER_VIEW_TYPE:
                return new ViewHolder(mLayoutInflater.inflate(
                        R.layout.all_apps_search_market_divider, parent, false));
            ...
            case FOLDER_VIEW_TYPE:
                // Create the folder iocn view
                FolderIcon icon = FolderIcon.getFolderIcon(
                        R.layout.folder_icon_app, mLauncher, parent);
        ...
        switch (holder.getItemViewType()) {
            case ICON_VIEW_TYPE: {
                ...
                if (mSupportEditAndHideApps) {
                    ...
                    if (info.isForPadding == AppInfo.NOT_PADDING_APP) {
                        // Disable the click listener in edit mode
                        if (LauncherPluginEx.sIsInEditMode) {
                        ...
                        // Disable all touch/click listener for padding app
                        icon.setText(null);
                    ...
                    // display the "Delete" button in the left-top corner of the app icon.
                    if (Launcher.isInEditMode() && !isSystemApp(info)
                        && (info.isForPadding == AppInfo.NOT_PADDING_APP)) {
                        icon.setDeleteButtonVisibility(true);
                    } else {
                        icon.setDeleteButtonVisibility(false);
                    }

                    if (mFolderIconPaddingTop != icon.getPaddingTop()) {
                        mFolderIconPaddingTop = icon.getPaddingTop();
                    }
                    break;
                }
                /// @}
            ...
            case FOLDER_VIEW_TYPE:
                ...
                // Unbind the folder info to clear the listeners
                folderInfo.unbind();

                FolderIcon icon = (FolderIcon) holder.mContent;
                icon = FolderIcon.fromXml(icon, R.layout.folder_icon_app, mLauncher,
                            null, folderInfo, null, true);
                // This folder icon is shown in app list
                icon.mIsPageViewFolderIcon = true;

                mFolderIconPaddingTop = mFolderIconPaddingTop != -1 ?
                    mFolderIconPaddingTop : FOLDER_ICON_PADDING_TOP;
                icon.setPadding(icon.getPaddingLeft(), mFolderIconPaddingTop,
