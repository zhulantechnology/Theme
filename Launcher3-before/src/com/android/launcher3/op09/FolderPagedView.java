...
public class FolderPagedView extends PagedView {
    ...
    public FolderPagedView(Context context, AttributeSet attrs) {
        ...
        /**M: ALPS02299998 Fix AOSP landspace folder display issue.@**/
    ...
    private void setupContentDimensions(int count) {
        ...
        while (!done) {
            ...
            if (mGridCountX * mGridCountY < count) {
                ...
                if ((mGridCountX <= mGridCountY || mGridCountY == mMaxCountY)
                    && mGridCountX < mMaxCountX) {
                    mGridCountX++;
    ...
    public View createNewView(ShortcutInfo item) {
        ...
        if (Launcher.mSupportEditAndHideApps && Launcher.isInEditMode()) {
            if (!Utilities.isSystemApp(item.makeAppInfo())) {
            ...
            if (v != null) {
                ...
                if (info.cellX != newX || info.cellY != newY || info.rank != rank) {
                    ...
                    if (saveChanges) {
                        ...
                        if (Launcher.mSupportEditAndHideApps
                            && mFolder.mFolderPluginEx.isPageViewFolder()) {
                            LauncherModelPluginEx.moveAllAppsItemInDatabase(getContext(), info,
