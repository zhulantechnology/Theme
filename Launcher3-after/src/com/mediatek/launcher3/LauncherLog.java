...
public final class LauncherLog {
    ...
    // should kill and restart launcher process to re-execute static block if
    // reset properties
    ...
    static {
        if (android.os.SystemProperties.getBoolean(PROP_DEBUG_ALL, false)) {
            ...
            DEBUG_LOADER = android.os.SystemProperties.getBoolean(PROP_DEBUG_LOADER, false);
            DEBUG_MOTION = android.os.SystemProperties.getBoolean(PROP_DEBUG_MOTION, false);
            DEBUG_PERFORMANCE = android.os.SystemProperties.getBoolean(PROP_DEBUG_PERFORMANCE,
                    false);
            ...
            DEBUG_LOADERS = android.os.SystemProperties.getBoolean(PROP_DEBUG_LOADERS, false);
