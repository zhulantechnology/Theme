...
public class FolderIcon extends FrameLayout implements FolderListener {
    ...
    private static boolean is_rect_folder = false ;
    private float mSlop;
    ...
    private void init() {
        //Add by xuemingwei for change the folder icon  20161012 start
        ...
        Log.i("xmw","is_rect_folder = "+is_rect_folder+", NUM_ITEMS_IN_PREVIEW = "+NUM_ITEMS_IN_PREVIEW);
        //Add by xuemingwei for change the folder icon  20161012 end
    ...
    public static class FolderRingAnimator {
        ...
        public static int sAvailableIconSpace = -1;//Add BUG_ID:NONE xuemingwei 20161012
        ...
        public FolderRingAnimator(Launcher launcher, FolderIcon folderIcon) {
            ...
            if (sStaticValuesDirty) {
                ...
                sAvailableIconSpace = res.getDimensionPixelSize(R.dimen.folder_available_icon_space);//Add BUG_ID:NONE xuemingwei 20161012
    ...
    private PreviewItemDrawingParams computePreviewItemDrawingParams(int index,
        ...
        //Modify BUG_ID:none xuemingwei 20161012(start)
        float transY;
        float transX;
        float totalScale;
        ...
        transY = mAvailableSpaceInPreview - (offset + scaledSize + scaleOffsetCorrection) + getPaddingTop();
        transX = (mAvailableSpaceInPreview - scaledSize) / 2;
        totalScale = mBaselineIconScale * scale;
        overlayAlpha =(80 * (1 - r)) / 255f;
        Log.i("xmw","r = "+r+", scale = "+scale+", offset = "+offset+", scaledSize = "+scaledSize+", scaleOffsetCorrection = "+scaleOffsetCorrection+", transY ="+transY+", transX = "+transX+", totalScale = "+totalScale+", overlayAlpha = "+overlayAlpha);
        }else{
            ...
            transY = topMarginY + scaledSize * row + itemPadding * row +1;
            totalScale = scale;
            overlayAlpha = 0;
            Log.i("xmw","mAvailableSpaceInFolderIcon= "+mAvailableSpaceInFolderIcon+", scale = "+scale+", scaledSize = "+scaledSize+", index = "+index+", topMarginY ="+topMarginY+", column ="+column+", row = "+row+", leftMargin = "+leftMargin+", transY ="+transY+", transX = "+transX+", totalScale = "+totalScale+", overlayAlpha = "+overlayAlpha);
        }
        //Modify BUG_ID:none xuemingwei 20161012(end)
        if (params == null) {
