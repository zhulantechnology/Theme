...
public class BaseRecyclerViewFastScrollBar {
    ...
    public BaseRecyclerViewFastScrollBar(BaseRecyclerView rv, Resources res) {
        ...
        mThumbWidth = mThumbMinWidth =
            res.getDimensionPixelSize(R.dimen.container_fastscroll_thumb_min_width);
    ...
    public void handleTouchEvent(MotionEvent ev, int downX, int downY, int lastY) {
        /// M: Add for OP customization. @{
        if (Launcher.mSupportEditAndHideApps && mRv instanceof AllAppsRecyclerView) {
            return;
        }
        /// @}
