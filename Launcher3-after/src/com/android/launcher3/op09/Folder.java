...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
        ...
        Stats.LaunchSourceProvider, View.OnTouchListener {
    ...
    public FolderPluginEx mFolderPluginEx;
    /// @}
    ...
    public Folder(Context context, AttributeSet attrs) {
        ...
        mFolderPluginEx = new FolderPluginEx(context, this);
    ...
    private boolean beginDrag(View v, boolean accessible) {
        ...
        if (tag instanceof ShortcutInfo) {
            ...
            if (mSupportEditAndHideApps && !Launcher.isInEditMode()
                && mFolderPluginEx.isPageViewFolder()) {
    ...
    public void enableAccessibleDrag(boolean enable) {
        ...
        for (int i = 0; i < mContent.getChildCount(); i++) {
            mContent.getPageAt(i).enableAccessibleDrag(enable,
                CellLayout.FOLDER_ACCESSIBILITY_DRAG);
        }
    ...
    public void doneEditingFolderName(boolean commit) {
        ...
        /// M: Modify for OP customization. @{
        if (mSupportEditAndHideApps && mFolderPluginEx.isPageViewFolder()) {
            LauncherModelPluginEx.updateAllAppsItemInDatabase(mLauncher, mInfo);
        } else {
    ...
    void bind(FolderInfo info) {
        ...
        for (ShortcutInfo item: overflow) {
            ...
            /// M: Modify for OP customization. @{
            if (mSupportEditAndHideApps && mFolderPluginEx.isPageViewFolder()) {
                LauncherModelPluginEx.deleteAllAppsItemFromDatabase(mLauncher, item);
            } else {
    ...
    public void animateOpen() {
        ...
        if (mSupportEditAndHideApps && Launcher.isInEditMode()) {
            ...
            mFolderPluginEx.updateContentDeleteButton();
        }
        /// @}
    ...
    public void onDragEnter(DragObject d) {
        LauncherLog.d(TAG, "onDragEnter: DragObject=" + d);
        mPrevTargetRank = -1;
    ...
    @Thunk void onDragOver(DragObject d, int reorderDelay) {
        LauncherLog.d(TAG, "onDragOver: DragObject=" + d);
    ...
    private void updateItemLocationsInDatabaseBatch() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            /// M: Add for OP customization. @{
            if (mSupportEditAndHideApps && mFolderPluginEx.isPageViewFolder()) {
                LauncherModelPluginEx.moveAllAppsItemInDatabase(mLauncher, info, mInfo.id, 0,
            ...
            public void run() {
                ...
                if (mSupportEditAndHideApps && mFolderPluginEx.isPageViewFolder()) {
                    ...
                    if (itemCount <= 1) {
                        ...
                        if (itemCount == 1) {
                            // Move the item from the folder to the workspace,
                            // in the position of the folder
                        ...
                        if (newIcon != null) {
                            ...
                            // from existing at the same time in the CellLayout.
                            // We need to add the new item with addInScreenFromBind()
                            // to ensure that hotseat items are placed correctly.
                            mLauncher.getWorkspace().addInScreenFromBind(
                                    newIcon, mInfo.container, mInfo.screenId,
        ...
        if (mIsExternalDrag) {
            ...
            if (mSupportEditAndHideApps && mFolderPluginEx.isPageViewFolder()) {
                if (d.dragInfo instanceof AppInfo) {
                    ...
                    mLauncher.getAppsView().mApps.mItems.remove(appInfo);
                    mLauncher.getAppsView().mApps.mItemsBackup.remove(appInfo);
                }
    ...
    public void onAdd(ShortcutInfo item) {
        ...
        if (mSupportEditAndHideApps && mFolderPluginEx.isPageViewFolder()) {
            LauncherModelPluginEx.moveAllAppsItemInDatabase(
                    mLauncher, item, mInfo.id, mInfo.screenId, item.cellX, item.cellY);
        } else {
            LauncherModel.addOrMoveItemInDatabase(
