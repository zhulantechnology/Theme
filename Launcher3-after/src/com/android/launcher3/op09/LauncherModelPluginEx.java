...
public class LauncherModelPluginEx {
    ...
    public static void addAllAppsItemToDatabase(Context context, final ItemInfo item,
        ...
        item.id = LauncherExtPlugin.getInstance().generateNewIdForAllAppsList();
    ...
    */
    ...
    public void loadAndBindAllAppsExt() {  //op09 private
        ...
        for (UserHandleCompat user : profiles) {
            ...
            final Callbacks callbacks =
                mLauncherModel.mLoaderTask == null ? null :
                mLauncherModel.mLoaderTask.tryGetCallbacks(oldCallbacks);
            ...
            mLauncherModel.mHandler.post(new Runnable() {
                public void run() {
                    ...
                    if (callbacks != null) {
                        ...
                        mLauncherModel.refreshAndBindWidgetsAndShortcuts(callbacks, true);
        ...
        final Runnable r = new Runnable() {
            public void run() {
                ...
                if (callbacks != null) {
                    ...
                    callbacks.bindWidgetsModel(widgetList);
                }
                if (DEBUG_LOADERS) {
    ...
    public void loadAllAppsExt(UserHandleCompat user, final ArrayList<ItemInfo> allItems,
        ...
        final boolean loadDefault = LauncherExtPlugin.getInstance()
                .loadDefaultAllAppsIfNecessary(LauncherProvider.getSQLiteDatabase(), mContext);
        final int screenCount = LauncherExtPlugin.getInstance()
                    ...
                    if (info != null && (!isSafeMode || Utilities.isSystemApp(info))) {
                        ...
                        if (resolveInfo == null
                            ...
                            if (container < 0) {
                                ...
                                if (LauncherLog.DEBUG_LOADER && LauncherLog.DEBUG) {
    ...
    */
    private void repositionOverlapApps(ArrayList<ItemInfo> allApps,  //op09 private
