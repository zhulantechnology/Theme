...
public class Launcher extends Activity
    ...
    /// M. ALPS02295402, add for RtoL layout.
    public static final int EXIT_SPRINGLOADED_MODE_SHORT_TIMEOUT_RTOL = 900;
    ...
    /// M: Add for OP customization. @{
    public static boolean mSupportEditAndHideApps = false;
    public LauncherPluginEx mPluginEx;
    /// @}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPluginEx = new LauncherPluginEx(this);
        /// @}
    ...
    private void handleActivityResult(
        ...
        if (requestCode == REQUEST_BIND_APPWIDGET) {
            ...
            return;
        /// M: Add for OP customization. @{
        } else if (requestCode == LauncherPluginEx.REQUEST_HIDE_APPS) {
            mWaitingForResult = false;
            mAppsView.mApps.processAppsStateChanged();
    ...
    private void setupOverviewPanel() {
        ...
        if (mSupportEditAndHideApps) {
            final View[] overviewPanelButtons = new View[] {
                    wallpaperButton, mWidgetsButton, settingsButton, null, null
            };

            mPluginEx.setHiddenAndEditButton(mOverviewPanel, overviewPanelButtons);
        }
        /// @}
    }
    ...
    private void addWidgetToAutoAdvanceIfNeeded(
                    View hostView, AppWidgetProviderInfo appWidgetInfo) {
        if (LauncherLog.DEBUG) {
                ...
                public void run() {
                    ...
                    if (Utilities.isRtl(getResources())
                        ...
                        exitSpringLoadedDragModeDelayed(true,
                            EXIT_SPRINGLOADED_MODE_SHORT_TIMEOUT_RTOL, null);
                    } else {
                        exitSpringLoadedDragModeDelayed(true,
                            EXIT_SPRINGLOADED_MODE_SHORT_TIMEOUT, null);
                    }
    ...
    public void openFolder(FolderIcon folderIcon) {
        ...
        /// M: Modify for OP customization. @{
        if (mSupportEditAndHideApps
            && (folderIcon.getLayoutParams() instanceof CellLayout.LayoutParams)) {
    ...
    public void closeFolder(Folder folder, boolean animate) {
        ...
        if (parent != null) {
            ...
            FolderIcon fi = null;
            if (mSupportEditAndHideApps
                && folder.mFolderPluginEx.isPageViewFolder()) {
                fi = folder.mFolderPluginEx.getFolderIcon();
            } else {
            ...
            if (mSupportEditAndHideApps
                && (fi.getLayoutParams() instanceof CellLayout.LayoutParams)) {
    ...
    protected void changeWallpaperVisiblity(boolean visible) {
        ...
        setWorkspaceBackground(visible ? WORKSPACE_BACKGROUND_GRADIENT
            : WORKSPACE_BACKGROUND_BLACK);
    }
    ...
    public boolean showWorkspace(boolean animated) {
        return showWorkspace(WorkspaceStateTransitionAnimation.SCROLL_TO_CURRENT_PAGE,
                animated, null);
    }
    ...
    public void bindItems(final ArrayList<ItemInfo> shortcuts, final int start, final int end,
        ...
        for (int i = start; i < end; i++) {
            ...
            if (item.container != LauncherSettings.Favorites.CONTAINER_DESKTOP
                ...
                Log.e(TAG, "bindItems: the container is wrong, item=" + item);
                continue;
            }
            /// @}
    ...
    public void bindAppWidget(final LauncherAppWidgetInfo item) {
        ...
        if (!item.hasRestoreFlag(LauncherAppWidgetInfo.FLAG_PROVIDER_NOT_READY) &&
            ...
            if (item.hasRestoreFlag(LauncherAppWidgetInfo.FLAG_ID_NOT_VALID)) {
                ...
                // click to setup view.
                PendingAddWidgetInfo pendingInfo = new PendingAddWidgetInfo(this,
                        appWidgetInfo, null);
    ...
    public void bindAppsUpdated(final ArrayList<AppInfo> apps) {
        if (LauncherLog.DEBUG) {
            LauncherLog.d(TAG, "bindAppsUpdated: apps.size="
                + (apps != null ? apps.size() : 0));
            if (apps != null && apps.size() > 0) {
                for (int i = 0; i < apps.size(); i++) {
                    LauncherLog.d(TAG, "bindAppsUpdated: apps[" + i + "]=" + apps.get(i));
                }
            }
        }
    ...
    public void bindWidgetsModel(WidgetsModel model) {
        if (LauncherLog.DEBUG) {
            LauncherLog.d(TAG, "bindWidgetsModel()");
        }
    ...
    // Whether the apps customize pane is in edit mode.
    public static boolean isInEditMode() {
        return LauncherPluginEx.sIsInEditMode;
    }

    // Click delete button will uinstall the app in edit mode.
    ...
    public void bindAllItems(ArrayList<AppInfo> allApps, ArrayList<AppInfo> apps,
        ...
        mPluginEx.bindAllItems(allApps, apps, folders);
    }

    public void refreshAppsView(boolean isUpdataData) {
        if (mAppsView != null && mAppsView.mApps != null) {
            mAppsView.mApps.refreshView(isUpdataData);
        }
    }
