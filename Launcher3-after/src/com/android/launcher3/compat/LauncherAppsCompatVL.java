...
public class LauncherAppsCompatVL extends LauncherAppsCompat {
	...
	//Add by huangchencong for hide app in launcher20161014(start)
    private Context mContext;
    private List<String> hideappsArrayList = new ArrayList<String>();
    //Add by huangchencong for hide app in launcher20161014(end)


    LauncherAppsCompatVL(Context context) {
        super();
        mLauncherApps = (LauncherApps) context.getSystemService("launcherapps");
		mContext = context;//Add by huangchencong for hide app in launcher20161014
    }
